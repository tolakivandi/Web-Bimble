 <?php
    ...
    $mahasiswa = mysqli_query($connection, "SELECT * FROM guru");
    ?>
 <!doctype html>
 <html>
...
-moz-box-shadow: 7px 14px 23px 0px rgba(0,0,0,0.75);">
             <thead class="text-white">
                 <tr>
                     ...
                     <th class="py-3 bg-cyan-800">ALAMAT</th>
                     <th class="py-3 bg-cyan-800">TELEPON</th>
                     <th class="py-3 bg-cyan-800">PENDIDIKAN</th>
             ...
             <tbody class="text-cyan-900 text-center">
                 ...
                 <?php foreach ($mahasiswa as $mhs) : ?>
                     <tr class="bg-cyan-200 cursor-pointer duration-300">
                         ...
                         <td class="py-3 px-6"> <?= $mhs["alamat"]; ?> </td>
                         <td class="py-3 px-6"> <?= $mhs["telepon"]; ?> </td>
                         <td class="py-3 px-6"> <?= $mhs["pendidikan"]; ?> </td>
                         <td class="py-3 px-6 flex gap-5 justify-center">
                             <a href="./guru/updateguru.php?id=<?= $mhs["nik"]; ?> " class="px-4 py-3 bg-cyan-500 rounded-xl text-black font-semibold border-black border-2">Update</a> |
                             <a href="./guru/deleteguru.php?id=<?= $mhs["nik"]; ?> " onclick="return confirm('yakin?');" class="px-4 py-3 bg-cyan-500 rounded-xl text-black font-semibold border-black border-2">Delete</a>
                         </td>
                     </tr>
                     <?php $i++; ?>
                 <?php endforeach; ?>
...
-webkit-box-shadow: 7px 14px 23px 0px rgba(0,0,0,0.75);
-moz-box-shadow: 7px 14px 23px 0px rgba(0,0,0,0.75);"> <a href="./guru/createguru.php">Tambah Data</a> </button>
     </div>
 </body>
