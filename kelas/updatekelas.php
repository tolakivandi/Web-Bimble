        ...
        <div class="md:flex w-1/3">
            <div class="w-full px-6 py-8 md:p-8">
                ...
                <form action="" method="POST">
                    <input type="hidden" name="id" value="<?= $mhs["id_kelas"] ?>">
                    <div class="mb-4">
                        <label class="block text-gray-700 font-bold mb-2" for="kelas">
                            Kelas
                        </label>
                        <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="kelas" name="kelas" type="text" placeholder="Masukkan Nama Kelas" value="<?= $mhs["kelas"] ?>">
                    </div>
