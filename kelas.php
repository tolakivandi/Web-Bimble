 <?php
    ...
    require './fungsi/functions_kelas.php';
    $mahasiswa = mysqli_query($connection, "SELECT * FROM kelas");
...
-moz-box-shadow: 7px 14px 23px 0px rgba(0,0,0,0.75);">
             ...
             <tbody class="text-cyan-900 text-center">
                 <tr class="bg-cyan-200 cursor-pointer duration-300">
                     ...
                     <td class="py-3 px-6"> <?= $mhs["kelas"]; ?> </td>

                     <td class="py-3 px-6 flex gap-5 justify-center">
                         <a href="./kelas/updatekelas.php?id=<?= $mhs["id_kelas"]; ?> " class="px-4 py-3 bg-cyan-500 rounded-xl text-black font-semibold border-black border-2">Update</a> |
                         <a href="./kelas/deletekelas.php?id=<?= $mhs["id_kelas"]; ?> " onclick="return confirm('yakin?');" class="px-4 py-3 bg-cyan-500 rounded-xl text-black font-semibold border-black border-2">Delete</a>
                     </td>
                 </tr>
                 <?php $i++; ?>
             <?php endforeach; ?>
         ...
         <button type="text" class=" bg-cyan-800 hover:bg-indigo-400 focus:bg-indigo-400 text-white font-semibold rounded-lg px-4 py-3 mt-6 ml-[583px] border-2 " style="box-shadow: 7px 14px 23px 0px rgba(0,0,0,0.75);
-webkit-box-shadow: 7px 14px 23px 0px rgba(0,0,0,0.75);
-moz-box-shadow: 7px 14px 23px 0px rgba(0,0,0,0.75);"> <a href="./kelas/createkelas.php">Tambah Data Kelas</a> </button>
     </div>
 </body>
