             ...
             <div class="w-full px-6 py-8 md:p-8">
                 ...
                 <form action="" method="POST">
                     <div class="mb-4">
                         ...
                         <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="mapel" name="mapel" type="text" placeholder="Masukkan Nama Mapel">
                     </div>
