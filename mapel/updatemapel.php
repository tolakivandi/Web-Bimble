     ...
     <div class="w-full h-screen flex justify-center items-center bg-white rounded-lg overflow-hidden">
         <div class="md:flex w-1/3">
             <div class="w-full px-6 py-8 md:p-8">
                 <h2 class="text-2xl font-bold text-gray-700 mb-2">Tambah Mapel</h2>
                 <form action="" method="POST">
                     <input type="hidden" name="id" value="<?= $mapel["id_mapel"] ?>">
                     <div class="mb-4">
                         <label class="block text-gray-700 font-bold mb-2" for="mapel">
                             Mapel
                         </label>
                         <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="mapel" name="mapel" type="text" placeholder="Masukkan Nama Mapel" value="<?= $mapel["mapel"] ?>">
                     </div>
